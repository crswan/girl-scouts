...
//print_r($_POST);
	...
	*/
	...
	//Email Sharon of new training sign-ups
	/* Sharon asked me to turn this off for now.  We can enable if we figure out how to send just one email for all training people sign up for.
