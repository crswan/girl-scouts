...
//print_r($_POST);
	...
	*/
	...
	"Did anything appear above?";
	
	$body = wordwrap($body, 70);
	
	//Send the email
	//mail('ahasel00@hotmail.com','New Training Registration!',$body);
	mail('clarerandyswan@yahoo.com','New Training Registration!',$body);
	}
...
echo "<H3>You are now registered for " . $trainingClasses[$i] . ".</h3>";
	 ...
	 /* while ( $result_row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		  ...
		  ?>
          <tr>
          <td><?php echo $result_row["trainingClasses"]; ?></td>
          </tr>
		  <?php
