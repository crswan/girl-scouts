...
// toggle("leftnav");
  ...
  <span style="padding:5px;"><a href="training_locations.html"><span class="training_button">Locations</span></a></span>
...
?>
	...
	?>
      ...
      <table>
        ...
        <tr>
          <td colspan="2">Have you previously attended Peninsula Day Camp as a Staff member?<br /><input type="radio" name="yearsAtCamp" size="70" value="Yes" />Yes
          <input type="radio" name="yearsAtCamp" size="70" value="no" />No</td>
          <td></td>
          </tr>
