<?php /* Smarty version Smarty-3.1.7, created on 2012-03-18 12:01:15
         compiled from "/home/peninsul/public_html/ui_templates/health_camper_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2331135434f4e8f96edfc09-95318811%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e59693be5445f5b0d1918b1daf23631556d9b420' => 
    array (
      0 => '/home/peninsul/public_html/ui_templates/health_camper_form.tpl',
      1 => 1332097225,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2331135434f4e8f96edfc09-95318811',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_4f4e8f9713306',
  'variables' => 
  array (
    'full_name' => 0,
...
<?php if ($_valid && !is_callable('content_4f4e8f9713306')) {function content_4f4e8f9713306($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('_header.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>'Health Forms'), 0);?>
...
"/></td>
  ...
  <tr>
    <td colspan="2"><p><span style="font-weight:bold;">Please list any restriction to food or activity for your child</span><br/>
	  <input class="long" type="text" name="food_activity_restrictions" id="food_activity_restrictions" value="<?php echo $_smarty_tpl->tpl_vars['food_activity_restrictions']->value;?>
" size="160"/></p>
	</td>
  </tr>
  <tr>
    <td colspan="2"><span style="font-weight:bold;">Please share any other information you feel the camp staff should have about your child's physical, emotional, or mental health</span><br/>
	  <input class="long" type="text" name="additional_health_info" id="additional_health_info" value="<?php echo $_smarty_tpl->tpl_vars['additional_health_info']->value;?>
" size="160"/>
	</td>
  </tr>
  ...
  <tr>
	<td colspan="2">
		...
		<p><span style="font-weight:bold">My signature below indicates</span>: This 
			health history is correct as far as i know, and <span style="font-weight:bold; text-decoration:underline;"><?php echo $_smarty_tpl->tpl_vars['full_name']->value;?>
</span> has 
			permission to engage in all prescribed activities, except as noted by the physician and me. <span style="font-weight:bold; text-decoration:underline;"><?php echo $_smarty_tpl->tpl_vars['full_name']->value;?>
</span> 
			is in good health. I give permission for <span style="font-weight:bold; text-decoration:underline;"><?php echo $_smarty_tpl->tpl_vars['full_name']->value;?>
</span> to receive treatment for routine medical and/or first 
			...
			<span style="font-weight:bold; text-decoration:underline;"><?php echo $_smarty_tpl->tpl_vars['full_name']->value;?>
</span> to 
